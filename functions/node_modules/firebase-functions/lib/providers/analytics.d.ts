...
export declare class UserDimensions {
    ...
    /**
     * A map of user interests set with the
     * [`setUserProperty`](https://firebase.google.com/docs/analytics/android/interests) API.
     *
...
/**
 * Predefined or custom interests stored on the client side.
 */
